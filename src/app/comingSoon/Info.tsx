            ...
            <div className="column lg-12">
                ...
                <nav className="tab-nav">
                    <ul className="tab-nav__list">
                        <li className="active" data-id="tab-about">
                            <a href="#tab-about">
                                About
                            </a>
                        </li>
                ...
                <div className="tab-content">
                            ...
                            <div className="column">
                                ...
                                <div className="row">
                                    ...
                                    <div className="column lg-6 tab-12">
                                        ...
                                        <a href="https://www.dreamhost.com/r.cgi?287326" className="btn btn--primary u-fullwidth">Get
                                            Started Now</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="tab-services" className='tab-content__item'>
                        ...
                        <div className="row services-list block-lg-one-half block-md-one-half block-tab-whole">
                            ...
                            <div className="column services-list__item">
                                <div className="services-list__item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                         style={{ fill: ":rgba(0, 0, 0, 1);transform:;-ms-filter:"}}>
                                        <path
                                            d="M12,6c-3.309,0-6,2.691-6,6s2.691,6,6,6s6-2.691,6-6S15.309,6,12,6z M12,16c-2.206,0-4-1.794-4-4s1.794-4,4-4s4,1.794,4,4 S14.206,16,12,16z"></path>
                                        <path
                                            d="M12,2C6.579,2,2,6.579,2,12s4.579,10,10,10s10-4.579,10-10S17.421,2,12,2z M12,20c-4.337,0-8-3.663-8-8s3.663-8,8-8 s8,3.663,8,8S16.337,20,12,20z"></path>
                            ...
                            <div className="column services-list__item">
                                <div className="services-list__item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                         style={{ fill: ":rgba(0, 0, 0, 1);transform:;-ms-filter:"}}>
                                        <path
                                            d="M19,3H5C3.897,3,3,3.897,3,5v14c0,1.103,0.897,2,2,2h14c1.103,0,2-0.897,2-2V5C21,3.897,20.103,3,19,3z M19,5l0.001,4H15h-2 H5V5H19z M5,11h8v8H5V11z M15,19v-8h4.001l0.001,8H15z"></path>
                                    </svg>
                                </div>
                                <div className="services-list__item-content">
                            ...
                            <div className="column services-list__item">
                                <div className="services-list__item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                         style={{ fill: ":rgba(0, 0, 0, 1);transform:;-ms-filter:"}}>
                                        <path
                                            d="M20,3H4C2.897,3,2,3.897,2,5v11c0,1.103,0.897,2,2,2h4l-1.8,2.4l1.6,1.2l2.7-3.6h3l2.7,3.6l1.6-1.2L16,18h4 c1.103,0,2-0.897,2-2V5C22,3.897,21.103,3,20,3z M4,16V5h16l0.001,11H4z"></path>
                            ...
                            <div className="column services-list__item">
                                <div className="services-list__item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                         style={{ fill: ":rgba(0, 0, 0, 1);transform:;-ms-filter:"}}>
                                        <path
                                            d="M20,3H7C5.897,3,5,3.897,5,5v2H4C2.897,7,2,7.897,2,9v10c0,1.103,0.897,2,2,2h6c1.103,0,2-0.897,2-2h8c1.103,0,2-0.897,2-2 V5C22,3.897,21.103,3,20,3z M9.997,19H4V9h2h4L9.997,19z M19.997,17H12V9c0-1.103-0.897-2-2-2H7V5h13L19.997,17z"></path>
                                    </svg>
                                </div>
                                <div className="services-list__item-content">
                            ...
                            <div className="column services-list__item">
                                ...
                                <div className="services-list__item-content">
                                    <h4 className="item-title">E-Commerce</h4>
                                    <p>
                                        Sit ut cum molestiae. Dolore ducimus qui quasi. Fugiat consequatur sit vel illum vel et
                                        a delectus. Vel sequi vitae voluptatem perspiciatis eligendi. Voluptatibus optio natus
                                        asperiores est commodi amet quia architecto. Dolores necessitatibus et.
                        ...
                        <div className="row">
                            <div className="column">
                                ...
                                <form id="mc-form" className="mc-form">
                                    <input type="email" name="EMAIL" id="mce-EMAIL" className="u-fullwidth text-center"
